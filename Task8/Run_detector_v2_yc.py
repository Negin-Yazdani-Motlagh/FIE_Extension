"""
Task 8: Run Detector v2 on YC Corpus
Goal: Apply refined lexicon v2 to YC corpus (2012-2024) to generate calibrated detection
"""
...
LEXICON_V2_FILE = TASK6_DIR / "lexicon_v2.csv"  # Lexicon v2

OUTPUT_FILE = TASK8_DIR / "yc_detector_v2_results.parquet"
SUMMARY_FILE = TASK8_DIR / "yc_detector_v2_summary.json"
LOG_FILE = TASK8_DIR / "task8_detector_v2_log.json"
...
def main():
    ...
    print("=" * 80)
    print("TASK 8: Run Detector v2 on YC Corpus")
    print("=" * 80)
